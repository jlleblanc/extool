...
{
	/**
	 * Name of the project to be generated by the representation
	 *
	 * @var string
	 */
	protected $name;

	// These arrays of objects are requried as a bare minimum. If any of these 
	// are left unset, the validate() function will return false.
	...
	{
		if (!isset($this->public_views) || 
			!isset($this->tables) || 
			!isset($this->public_models) || 
			!isset($this->name)) {
			return false;
		}
	...
	/**
	 * Sets the name used for the representation
	 *
	 * @param string $name 
	 * @return void
	 * @author Joseph LeBlanc
